...
from .base import fetch_dataset, get_data_home, load_file, DataBundle
...
def download_movie_reviews(target_dir, cache_path):
    ...
    cv = ShuffleSplit(n_iter=1, test_size=0.1, random_state=1234)
...
def fetch_movie_reviews(as_onehot=False):
    ...
    return fetch_dataset(cache, as_onehot=as_onehot)
